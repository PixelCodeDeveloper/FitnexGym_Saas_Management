...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RTPassView.aspx.cs" Inherits="RTLogView" ValidateRequest="false"%>
...
<body>
    <script type="text/javascript">
        function viewfunc(devid, userid, iotime) {
            alert("devid :" + devid + " userid:" + userid + " iotime:" + iotime);
        }
    </script>
    ...
    &nbsp;&nbsp; FKAttend BS Sample</div>
        ...
        <asp:Panel ID="Panel2" runat="server" style="margin-top: 13px">
            <asp:GridView ID="gvDoorstatus" runat="server" AutoGenerateColumns="False" 
            Width="893px"
            onsorting="gvDoorstatus_Sorting"
            autogenerateselectbutton="True"
            onpageindexchanging="gvDoorstatus_PageIndexChanging"
            >
            ...
            SortExpression="device_id" />
                    <asp:BoundField DataField="door_status" HeaderText="Door Status" ReadOnly="True"  
