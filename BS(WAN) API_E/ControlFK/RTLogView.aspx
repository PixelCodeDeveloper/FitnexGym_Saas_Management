...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RTLogView.aspx.cs" Inherits="RTLogView" ValidateRequest="false"%>
...
<body>
    ...
    &nbsp;&nbsp; FKAttend BS Sample</div>
        ...
        <asp:Panel ID="Panel2" runat="server" style="margin-top: 13px">
            ...
            autogenerateselectbutton="True" onselectedindexchanged="gvLog_SelectedIndexChanged"
