...
<body style="font-weight: 700">
    ...
    <asp:Panel ID="Panel2" runat="server" BorderStyle="Groove" Height="200px" 
        ...
        &nbsp;&nbsp;
        <asp:Label ID="Labelmodel" runat="server" Text="DevModel:  "></asp:Label>
        <asp:Label ID="LDev_Model" runat="server"></asp:Label>
        <br />
        <br />
        &nbsp;&nbsp;
        ...
        <asp:Label ID="LDev_Info" runat="server"></asp:Label>
         <br />
        <br />
        &nbsp;&nbsp;
        <asp:Label ID="Label12" runat="server" Text="DevStatus:  "></asp:Label>
        <asp:Label ID="LDev_Status" runat="server"></asp:Label>
    </asp:Panel>
    <asp:Panel ID="Panel3" runat="server" BorderStyle="Groove" Height="263px" 
        ...
        <asp:Button ID="RTLogBtn" runat="server" Height="30px" 
            Text="Real-time Log View" Width="200px" onclick="RTLogBtn_Click" />
        <br />
        <br />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <asp:Button ID="RTEnrollBtn" runat="server" Height="30px" 
            Text="Real-time Enroll View" Width="200px" onclick="RTEnrollBtn_Click" />
        <br />
        <br />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="RTDoorBtn" runat="server" Height="30px"  
            Text="Real-time DoorStatus View" Width="200px" onclick="RTDoorBtn_Click" />
        <br />
        <br />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="PassManBtn" runat="server" Height="30px" Text="Pass Manage" 
            Width="150px" onclick="PassManBtn_Click" />
          <br />
        <br />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="GetDevStatus" runat="server" Height="30px" onclick="GetDevStatus_Click" Text="Get DevStatus" Width="148px" />
        </asp:Panel>
