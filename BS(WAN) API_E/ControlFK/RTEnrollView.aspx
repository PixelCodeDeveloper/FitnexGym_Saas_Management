<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RTEnrollView.aspx.cs" Inherits="RTEnrollView" ValidateRequest="false"%>
        ...
        <asp:Panel ID="Panel2" runat="server" style="margin-top: 13px">
            ...
            <asp:Panel ID="Panel5" runat="server" BorderStyle="Groove" Height="44px" 
                ...
                <asp:Label ID="StatusTxt" runat="server"></asp:Label>
                 &nbsp; &nbsp;&nbsp;&nbsp;<asp:Button ID="GetAllUserInfo" runat="server" Enabled="True" 
                Text="GetAllUserInfo" Width="130px" OnClick="GetAllUserInfo_Click" />
            </asp:Panel>
