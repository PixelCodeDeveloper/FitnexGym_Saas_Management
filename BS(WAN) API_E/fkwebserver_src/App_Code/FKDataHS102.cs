...
{
    //{ 하오쑨 4775 리눅스얼굴기대에서 리용하는 문자렬아이디 자료클라스이다.
    ...
    */
    ...
    public class SLog
    {
        ...
        public const Int32 STRUCT_SIZE = 40;        // sizeof(GLOG_DATA_CIF13)
        public const Int32 USER_ID_LEN = 16;
        ...
        public SLog(byte[] abytLog)
        {
            ...
            UserId = new byte[USER_ID_LEN];
            Buffer.BlockCopy(abytLog, 4,
                            UserId, 0,
                            USER_ID_LEN);
            toUserId = new byte[USER_ID_LEN];
            Buffer.BlockCopy(abytLog, 20,
                            toUserId, 0,
                            USER_ID_LEN);
        ...
        {
            return System.Text.Encoding.Default.GetString(toUserId).TrimEnd('\0');
        }
    ...
    public class UserIdInfo
    {
        ...
        public const Int32 STRUCT_SIZE = 20;        // sizeof(USER_ID_CIF13)
