              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Select master template or customize macros & review date', style: TextStyle(fontSize: 12, color: isDark ? Colors.grey[400] : const Color(0xFF475569))),
                    const SizedBox(height: 16),
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 6),
                    Text('Log a payment transaction for ${_member.name}', style: TextStyle(fontSize: 12, color: isDark ? Colors.grey[400] : const Color(0xFF475569))),
                    const SizedBox(height: 16),
